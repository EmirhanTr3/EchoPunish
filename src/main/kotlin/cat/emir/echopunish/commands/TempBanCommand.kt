...
class TempBanCommand(plugin: EchoPunish) : EchoCommand<EchoPunish>(plugin) {
    ...
    fun execute(ctx: CommandContext<CommandSourceStack>, silent: Boolean, reason: String): Int {
        ...
        ifNotExempt(sender, player, Punishment.Type.TEMPBAN, "echopunish.tempban.exempt") {
            val punishment = Punishment(
                type = Punishment.Type.TEMPBAN,
